...
@store2.employees.create(first_name: "Dasher", last_name: "McQuade", hourly_rate: 55)
@store2.employees.create(first_name: "Slammer", last_name: "Kaboom", hourly_rate: 55)
@store2.employees.create(first_name: "Bazoo", last_name: "Zapow", hourly_rate: 65)
